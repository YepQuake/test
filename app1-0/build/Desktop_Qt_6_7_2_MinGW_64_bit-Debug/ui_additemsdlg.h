...
public:
    ...
    void setupUi(QDialog *AdditemsDlg)
    {
        ...
        spinBoxnumber = new QSpinBox(gridLayoutWidget);
        ...
        doubleSpinBoxprice = new QDoubleSpinBox(gridLayoutWidget);
        doubleSpinBoxprice->setObjectName("doubleSpinBoxprice");

        gridLayout->addWidget(doubleSpinBoxprice, 2, 1, 1, 1);
